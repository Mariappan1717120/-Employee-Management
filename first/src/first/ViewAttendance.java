...
class ViewAttendance{
	public ViewAttendance()
	{
		...
		try{
			...
			PreparedStatement ps=con.prepareStatement("select date,intime,outtime from work where name=? group by date");
			ps.setString(1,user);
	...
	public static void main(String[] args) {
		ViewAttendance vp= new ViewAttendance();
		}
